class Warpclip < Formula
  ...
  url "https://github.com/mquinnv/warpclip/archive/refs/tags/v2.1.10.tar.gz"
  sha256 "3d5043405a5930ec42a055b4afec9a4d2fff8102ed2123eb16ee8f39f986ee28"
  license "MIT"
...
Host *
  ...
  def caveats
    <<~EOS
      WarpClip v2.1.10 has been installed. To start the clipboard service:
